...
var isMobile = {
  ...
  BlackBerry: function () {
    if (this._blackberry === undefined) {
      if (
        (this._blackberry = navigator.userAgent.match(/BlackBerry/i) !== null)
      ) {
  ...
  iOS: function () {
    if (this._ios === undefined) {
      if (
        (this._ios = navigator.userAgent.match(/iPhone|iPad|iPod/i) !== null)
      ) {
  ...
  OperaMini: function () {
    if (this._operamini === undefined) {
      if (
        (this._operamini = navigator.userAgent.match(/Opera Mini/i) !== null)
      ) {
